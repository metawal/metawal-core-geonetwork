...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};(function(){var a=angular.module("gn_utility_service",[]);a.factory("gnUtilityService",function(){var a=function(c){angular.forEach(c,function(d,e){if("string"==typeof d)if("true"==d||"false"==d)c[e]="true"==d;else{if("on"==d||"off"==d)c[e]="on"==d}else a(d)})};return{scrollTo:function(a,b,e,g){$(document.body).animate({scrollTop:b?$(a).offset().top:$(a).position().top},e,g)},serialize:function(a){a=$(a);var b=[];$(":checkbox:not(:checked)",a).each(function(){b.push(encodeURIComponent(this.name)+
"=false")});return a.serialize()+(b.length?"&"+b.join("&").replace(/%20/g,"+"):"")},parseBoolean:a,toCsv:function(a,b,e){var g,f,h=[],k,l,n,m,p="",q,r;if("undefined"===typeof b||null===b)b='"';if("undefined"===typeof e||null===e)e=",";g=0;for(f=a.length;g<f;g+=1){n=a[g];m="";if(0===g){for(k in n)n.hasOwnProperty(k)&&(h.push(k),m+=[b,k,b,e].join(""));m=m.substring(0,m.length-1);p+=m}p+="\n";m="";q=0;for(r=h.length;q<r;q+=1){k=h[q];l=n[k];0<q&&(m+=",");var s='"',t=typeof l,u=void 0;if("undefined"===
typeof s||null===s)s='"';u="undefined"===t||null===t?"":"string"===t?s+l+s:String(l);m+=u}p+=m}return p}}});a.filter("gnFromNow",function(){return function(a){return moment(new Date(a)).fromNow()}})})();(function(){var a=angular.module("gn_search_manager_service",[]),b=function(a,b,e){var g=function(a){var b={},c=-1;a[0]&&a[0]["@count"]&&(a.summary=a[0],c=a[0]["@count"]);for(var d in a.summary)"@count"!=d?(b[d]=a.summary[d],b[d].name=d):c=a.summary[d];if(a.metadata)for(d=0;d<a.metadata.length||!$.isArray(a.metadata)&&1>d;d++){var f=$.isArray(a.metadata)?a.metadata[d]:a.metadata;"string"===typeof f.image&&(f.image=[f.image]);"string"===typeof f.link&&(f.link=[f.link]);f["geonet:info"].selected="true"==
...
function(b){a.searchRecordsFilter={any:b?b.target.value:""};a.searchRecordsPagination.currentPage=0;searchFn()};a.$watch("searchRecordsPagination.currentPage",function(){searchFn()})}])})();(function(){var a=angular.module("gn","ngRoute pascalprecht.translate gn_language_switcher gn_utility_service gn_search_manager gn_metadata_manager gn_search_results gn_pagination gn_cat_controller gn_search_controller".split(" "));a.constant("$LOCALES",["core"]);a.factory("localeLoader",["$http","$q",function(a,c){return function(d){var e=[];angular.forEach(d.locales,function(g,f){var h=d.prefix+d.key+"-"+g+d.suffix,k=c.defer();e.push(k.promise);a({method:"GET",url:h}).success(function(a,b,c,d){k.resolve(a)}).error(function(a,
...
b}).error(function(a){}).then(function(){b.userOrGroup&&angular.forEach(a.users,function(c){c.username===b.userOrGroup&&a.selectUser(c)})})}a.pageMenu={folder:"usergroup/",defaultTab:"groups",tabs:[{type:"groups",label:"manageGroups",icon:"icon-group",href:"#/organization/groups"},{type:"users",label:"manageUsers",icon:"icon-user",href:"#/organization/users"}]};a.groupRecordsPagination={pages:-1,currentPage:0,hitsPerPage:10};a.groups=null;a.groupSelected={id:b.userOrGroup};a.groupRecords=null;a.groupRecordsFilter=
...
"#"+a.keywordSelected.value["#text"].replace(/[^\d\w]/gi,"")};a.useSuggestedUri=function(){a.keywordSelected.uri=a.keywordSuggestedUri};a.isPlaceType=function(){return a.thesaurusSelected?a.thesaurusSelected.key&&-1!==a.thesaurusSelected.key.indexOf(".place."):!1};a.isExternal=function(){return a.thesaurusSelected?"external"===a.thesaurusSelected.type:!1};a.$watch("maxNumberOfKeywords",function(){searchThesaurusKeyword()});a.$watch("keywordFilter",function(){searchThesaurusKeyword()});e()}])})();(function(){angular.module("gn_classification_controller",["gn_thesaurus_controller","gn_categories_controller"]).controller("GnClassificationController",["$scope","$http",function(a,b){a.pageMenu={folder:"classification/",defaultTab:"thesaurus",tabs:[{type:"thesaurus",label:"manageThesaurus",icon:"icon-archive",href:"#/classification/thesaurus"},{type:"directory",label:"manageDirectory",icon:"icon-list-ul",href:"subtemplate.admin"},{type:"categories",label:"manageCategory",icon:"icon-tags",href:"#/classification/categories"}]}}])})();(function(){angular.module("gn_admintools_controller",[]).controller("GnAdminToolsController",["$scope","$http","$rootScope","$translate","$compile","$q","$timeout","gnMetadataManagerService","gnSearchManagerService","gnUtilityService",function(a,b,c,d,e,g,f,h,k,l){function n(){return b.get("md.processing.batch.report@json").success(function(b,c){"null"!=b&&(a.processReport=b,a.numberOfRecordsProcessed=b["@processedRecords"]);a.processReport&&"true"==a.processReport["@running"]&&f(n,p)})}function m(){return b.get("info@json?type=index").success(function(c,
d){a.isIndexing="true"==c.index;a.isIndexing&&f(m,q);b.get("qi@json?template=y or n or s&summaryOnly=true").success(function(b,c){a.numberOfIndexedRecords=b[0]["@count"]})})}a.pageMenu={folder:"tools/",defaultTab:"index",tabs:[{type:"index",label:"indexAdmin",icon:"icon-search",href:"#/tools/index"},{type:"batch",label:"batchProcess",icon:"icon-medkit",href:"#/tools/batch"},{type:"transfert-privs",label:"transfertPrivs",href:"transfer.ownership"},{type:"formatter",label:"manageFormatter",href:"metadata.formatter.admin"}]};
a.processing=!1;a.recordsToProcessFilter="";a.processReport=null;a.processReportWarning=!1;a.recordsToProcess=null;a.numberOfRecordsProcessed=null;a.recordsToProcessPagination={pages:-1,currentPage:0,hitsPerPage:10};a.selectedProcess=null;a.batchProcesses=null;a.batchSearchTemplateY=!0;a.batchSearchTemplateN=!0;a.batchSearchTemplateS=!1;a.batchSearchGroups={};a.batchSearchUsers={};a.batchSearchCategories={};var p=1E3;a.runProcess=function(e){a.processing=!0;a.processReport=null;b.get("md.processing.batch@json?"+
$(e).serialize()).success(function(b){a.processReport=b;a.processReportWarning=0!=b.notFound||0!=b.notOwner||0!=b.notProcessFound;c.$broadcast("StatusUpdated",{msg:d("processFinished"),timeout:2,type:"success"});a.processing=!1;n()}).error(function(b){c.$broadcast("StatusUpdated",{title:d("processError"),error:b,timeout:0,type:"danger"});a.processing=!1});l.scrollTo("#gn-batch-process-report");f(n,p)};(function(){b.get(a.base+"config/batch-process-cfg.json").success(function(b){a.batchProcesses=b.config})})();
n();(function(){b.get("admin.group.list@json").success(function(b){a.batchSearchGroups=b}).error(function(a){})})();(function(){b.get("admin.user.list@json").success(function(b){a.batchSearchUsers=b}).error(function(a){})})();(function(){b.get("info@json?type=categories").success(function(b){a.batchSearchCategories=b.categories}).error(function(a){})})();a.recordsToProcessSearchFor=function(b){a.recordsToProcessFilter=b?b.target.value:"";a.recordsToProcessPagination.currentPage=0;a.recordsToProcessSearch()};
a.recordsToProcessSearch=function(){var b=a.recordsToProcessPagination,b=[{fast:"index"},{from:b.currentPage*b.hitsPerPage+1},{to:(b.currentPage+1)*b.hitsPerPage},{any:a.recordsToProcessFilter}];templateValues=[];angular.forEach({"#gn-batchSearchTemplateY":"y","#gn-batchSearchTemplateN":"n","#gn-batchSearchTemplateS":"s"},function(a,b){$(b)[0]&&$(b)[0].checked&&templateValues.push(a)});b.push({template:templateValues.join(" or ")});if($("#gn-batchSearchGroupOwner")[0]){var c=$("#gn-batchSearchGroupOwner")[0].options[$("#gn-batchSearchGroupOwner")[0].selectedIndex].value;
""!==c&&b.push({group:c})}$("#gn-batchSearchOwner")[0]&&(c=$("#gn-batchSearchOwner")[0].options[$("#gn-batchSearchOwner")[0].selectedIndex].value,""!==c&&b.push({_owner:c}));$("#gn-batchSearchCategory")[0]&&(c=$("#gn-batchSearchCategory")[0].options[$("#gn-batchSearchCategory")[0].selectedIndex].value,""!==c&&b.push({category:c}));var d="";angular.forEach(b,function(a){angular.forEach(a,function(a,b){d+=b+"="+a+"&"})});k.search("q@json?"+d).then(function(b){a.recordsToProcess=b;a.recordsToProcessPagination.pages=
Math.round(b.count/a.recordsToProcessPagination.hitsPerPage,0)},function(a){})};angular.forEach(["recordsToProcessPagination.currentPage"],function(b){a.$watch(b,function(){a.recordsToProcessSearch()})});h.selectNone().then(function(){a.recordsToProcessSearch()});a.isIndexing=!1;a.numberOfIndexedRecords=null;var q=1E3;m();a.rebuildIndex=function(){b.get("admin.index.rebuild?reset=yes").success(function(a){m()}).error(function(a){c.$broadcast("StatusUpdated",{title:d("rebuildIndexError"),error:a,timeout:0,
type:"danger"})})};a.optimizeIndex=function(){b.get("admin.index.optimize").success(function(a){c.$broadcast("StatusUpdated",{msg:d("indexOptimizationInProgress"),timeout:2,type:"success"})}).error(function(a){c.$broadcast("StatusUpdated",{title:d("rebuildIndexError"),error:a,timeout:0,type:"danger"})})};a.reloadLuceneConfig=function(){b.get("admin.index.config.reload").success(function(a){c.$broadcast("StatusUpdated",{msg:d("luceneConfigReloaded"),timeout:2,type:"success"})}).error(function(a){c.$broadcast("StatusUpdated",
{title:d("rebuildIndexError"),error:a,timeout:0,type:"danger"})})};a.clearXLinkCache=function(){b.get("admin.index.rebuildxlinks").success(function(a){c.$broadcast("StatusUpdated",{msg:d("xlinkCacheCleared"),timeout:2,type:"success"})}).error(function(a){c.$broadcast("StatusUpdated",{title:d("rebuildIndexError"),error:a,timeout:0,type:"danger"})})}}])})();(function(){angular.module("gn_adminmetadata_controller",[]).controller("GnAdminMetadataController",["$scope","$routeParams","$http","$rootScope","$translate","$compile","gnMetadataManagerService","gnSearchManagerService","gnUtilityService",function(a,b,c,d,e,g,f,h,k){function l(){c.get("admin.schema.list@json").success(function(c){for(var d=0;d<c.length;d++)a.schemas.push(c[d]["#text"].trim());a.schemas.sort();"all"===b.schema?a.selectAllSchemas(!0):void 0!==b.schema&&a.selectSchema(b.schema.split(","));
"load-samples"===b.metadataAction?a.loadSamples():"load-templates"===b.metadataAction?a.loadTemplates():"load-samples-and-templates"===b.metadataAction&&(a.loadSamples(),a.loadTemplates())})}a.pageMenu={folder:"metadata/",defaultTab:"metadata-and-template",tabs:[{type:"metadata-and-template",label:"metadataAndTemplates",icon:"icon-archive",href:"#/metadata/metadata-and-template"},{type:"template-sort",label:"sortTemplate",icon:"icon-sort",href:"#/metadata/template-sort"}]};a.schemas=[];a.selectedSchemas=
...
"1"==a.harvester.privileges[0]["@id"]&&$("#gn-harvester-visible-all").button("toggle")}}}])})();(function(){angular.module("gn_harvester",["gn_harvester_directive"])})();(function(){angular.module("gn_category_directive",[]).directive("gnCategory",["$http","$translate",function(a,b){return{restrict:"A",replace:!0,transclude:!0,scope:{element:"=gnCategory",lang:"@lang",label:"@label"},templateUrl:"../../catalog/components/category/partials/category.html",link:function(b,d,e){a.get("info@json?type=categories").success(function(a){b.categories=a.categories}).error(function(a){})}}}])})();(function(){angular.module("gn_category",["gn_category_directive"])})();(function(){angular.module("gn_harvest_controller",["gn_harvester","gn_category"]).controller("GnHarvestController",["$scope","$http","$translate","$injector","$rootScope","gnSearchManagerService","gnUtilityService",function(a,b,c,d,e,g,f){function h(){return b.get("admin.harvester.list@json").success(function(b){"null"!=b&&(a.harvesters=b,f.parseBoolean(a.harvesters))}).error(function(a){})}function k(){a.harvesterHistory=void 0;b.get("admin.harvester.history@json?uuid="+a.harvesterSelected.site.uuid).success(function(b){a.harvesterHistory=
b.response}).error(function(a){})}a.pageMenu={folder:"harvest/",defaultTab:"harvest",tabs:[]};a.harvesterTypes={};a.harvesters={};a.harvesterSelected=null;a.harvesterUpdated=!1;a.harvesterNew=!1;a.harvesterHistory={};a.harvesterRecordsPagination={pages:-1,currentPage:0,hitsPerPage:10};a.harvesterRecords=null;a.harvesterRecordsFilter=null;a.harvesterRecordsSearch=g.register({records:"harvesterRecords",filter:"harvesterRecordsFilter",pager:"harvesterRecordsPagination"},a);a.$watch("harvesterRecordsPagination.currentPage",
...
loadLogo()}).error(function(a){c.$broadcast("StatusUpdated",{title:d("logoRemoveError"),error:a,timeout:0,type:"danger"});loadLogo()})};loadLogo()}])})();(function(){angular.module("gn_csw_settings_controller",[]).controller("GnCSWSettingsController",["$scope","$http","$rootScope","$translate","gnUtilityService",function(a,b,c,d,e){function g(){b.get("xml.config.get@json?asTree=false").success(function(b){for(var c=0;c<b.length;c++){var d=b[c];if(-1!==k.indexOf(d["@name"])){var e=d["#text"].toLowerCase();a.cswSettings[d["@name"]]="true"==e||"on"==e}else-1!==h.indexOf(d["@name"])&&(a.cswSettings[d["@name"]]=d["#text"])}}).error(function(a){})}function f(){b.get("admin.config.csw.customelementset@json").success(function(b){a.cswElementSetName=
b.xpath})}var h=["system/csw/contactId"],k=["system/csw/enable","system/csw/metadataPublic"];a.cswSettings={};a.cswElementSetName=[];a.cswFieldFilterValue="";a.cswLanguageFilterValue=a.lang;a.cswLanguages={};a.cswFields={};a.addCSWElementSetName=function(){a.cswElementSetName.push([""])};a.deleteElementSetName=function(b){b=$.inArray(b,a.cswElementSetName);a.cswElementSetName.splice(b,1)};a.saveCSWElementSetName=function(a){b.get("admin.config.csw.customelementset.save@json?"+$(a).serialize()).success(function(a){f()})};
a.saveSettings=function(a){l(a,"admin.config.save")};a.saveProperties=function(a){l(a,"admin.config.csw.save")};var l=function(a,f){b.get(f+"?"+e.serialize(a)).success(function(a){c.$broadcast("StatusUpdated",{msg:d("settingsUpdated"),timeout:2,type:"success"})}).error(function(a){c.$broadcast("StatusUpdated",{title:d("settingsUpdateError"),error:a,timeout:0,type:"danger"})})};a.cswFilter=function(b){var c=[],d=a.cswFieldFilterValue,e=a.cswLanguageFilterValue;b&&angular.forEach(b,function(a,f){var g=
!1;""!==e&&""===d&&b[f].langid===e&&(g=!0);""!==d&&""===e&&b[f].field===d&&(g=!0);""!==d&&""!==e&&b[f].langid===e&&b[f].field===d&&(g=!0);""===d&&""===e&&(g=!0);g&&c.push(b[f])});return c};(function(){b.get("admin.user.list@json").success(function(b){a.users=b;g()}).error(function(a){})})();(function(){b.get("admin.config.csw@json").success(function(b){a.cswConfig=b.record;angular.forEach(a.cswConfig,function(b,c){a.cswLanguages[a.cswConfig[c].langid]=!0;a.cswFields[a.cswConfig[c].field]=!0});g()}).error(function(a){})})();
f()}])})();(function(){angular.module("gn_csw_virtual_controller",[]).controller("GnCSWVirtualController",["$scope","$http","$rootScope","$translate",function(a,b,c,d){function e(){a.virtualCSWSelected={};b.get("admin.config.virtualcsw.list@json").success(function(b){a.cswVirtual=b}).error(function(a){})}a.cswVirtual={};a.virtualCSWSelected=null;a.virtualCSWUpdated=!1;a.virtualCSWSearch="";a.groupsFilter={};a.sourcesFilter={};a.categoriesFilter={};var g="";a.updatingVirtualCSW=function(){a.virtualCSWUpdated=
!0};a.selectVirtualCSW=function(c){g="updateservice";b.get("admin.config.virtualcsw.get@json?id="+c.id).success(function(b){a.virtualCSWSelected=b;a.virtualCSWUpdated=!1}).error(function(a){})};a.addVirtualCSW=function(){g="newservice";a.virtualCSWSelected={record:{id:"",name:"csw-servicename",description:""},filter:{any:"","abstract":"",title:"",_source:"",_groupPublished:"",keyword:"",_cat:"",denominator:"",type:""}}};a.saveVirtualCSW=function(a){b.get("admin.config.virtualcsw.update@json?operation="+
g+"&"+$(a).serialize()).success(function(a){e();c.$broadcast("StatusUpdated",{msg:d("virtualCswUpdated"),timeout:2,type:"success"})}).error(function(a){c.$broadcast("StatusUpdated",{title:d("virtualCswUpdateError"),error:a,timeout:0,type:"danger"})})};a.deleteVirtualCSW=function(){b.get("admin.config.virtualcsw.remove?id="+a.virtualCSWSelected.record.id).success(function(a){e()}).error(function(a){c.$broadcast("StatusUpdated",{title:d("virtualCswDeleteError"),error:a,timeout:0,type:"danger"})})};
a.getCapabilitiesUrl=function(a){return a&&a.record?a.record.name+"?SERVICE=CSW&REQUEST=GetCapabilities":null};e();(function(){b.get("admin.group.list@json").success(function(b){a.groupsFilter=b}).error(function(a){})})()}])})();(function(){angular.module("gn_settings_controller",["gn_system_settings_controller","gn_csw_settings_controller","gn_csw_virtual_controller","gn_csw_test_controller","gn_logo_settings_controller"]).controller("GnSettingsController",["$scope",function(a){a.pageMenu={folder:"settings/",defaultTab:"system",tabs:[{type:"system",label:"settings",icon:"icon-cogs",href:"#/settings/system"},{type:"logo",label:"manageLogo",icon:"icon-picture",href:"#/settings/logo"},{type:"csw",label:"manageCSW",href:"#/settings/csw"},
{type:"csw-virtual",label:"manageVirtualCSW",href:"#/settings/csw-virtual"},{type:"csw-test",label:"testCSW",href:"#/settings/csw-test"}]}}])})();(function(){var a=angular.module("gn_admin_controller","gn_dashboard_controller gn_usergroup_controller gn_admintools_controller gn_settings_controller gn_adminmetadata_controller gn_classification_controller gn_harvest_controller gn_standards_controller".split(" "));a.config(["$routeProvider",function(a){a.when("/metadata",{templateUrl:"../../catalog/templates/admin/page-layout.html",controller:"GnAdminMetadataController"}).when("/metadata/:tab",{templateUrl:"../../catalog/templates/admin/page-layout.html",
